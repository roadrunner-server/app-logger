...
func (r *RPC) ErrorWithContext(in *v1.LogEntry, _ *v1.Response) error {
	r.log.Error(in.GetMessage(), format(r.cfg.AllowUnstructuredContext, in.GetLogAttrs())...)
...
func (r *RPC) InfoWithContext(in *v1.LogEntry, _ *v1.Response) error {
	r.log.Info(in.GetMessage(), format(r.cfg.AllowUnstructuredContext, in.GetLogAttrs())...)
...
func (r *RPC) WarningWithContext(in *v1.LogEntry, _ *v1.Response) error {
	r.log.Warn(in.GetMessage(), format(r.cfg.AllowUnstructuredContext, in.GetLogAttrs())...)
...
func (r *RPC) DebugWithContext(in *v1.LogEntry, _ *v1.Response) error {
	r.log.Debug(in.GetMessage(), format(r.cfg.AllowUnstructuredContext, in.GetLogAttrs())...)
